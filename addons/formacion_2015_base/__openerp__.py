...
# Generated by the OpenERP plugin for Dia !
{
        ...
        "update_xml" :  ['data/modalidades.xml',
                        ...
                        'data/areas_economicas.xml', 
                        'data/subareas_economicas.xml', 
                        'data/for.pis.tipos_procedencias.csv', 
                        'data/estados.xml', 
                        'data/municipios.xml', 
                        'data/parroquias.xml', 
                        'data/cfs.xml',
                        'security/for_pis_base.xml', 
                        'security/ir.model.access.csv',
                        'security/ir.rule.xml', 
                        'formacion_pis_base_view.xml', 
                        'data/for.pis.opciones_formativas.csv', 
                        'data/areas_priorizadas.xml',
