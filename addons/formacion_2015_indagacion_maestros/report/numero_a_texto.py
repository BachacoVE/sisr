...
#_n11 =( "un","dós","trés","cuatro","cinco","séis","siete","ocho","nueve") #Descomentar y comentar la linea siguiente si se desea imprir solo en minuscula
...
class Numero_a_Texto:
    ...
    Ejemplo de uso:
        ...
        num2cad.EnLetras('22754701').escribir
    ...
    def __init__(self,num):
        try:
            ...
            letras = '"ERROR EN EL DATO MOSTRADO"'
...
if __name__ == "__main__" :
    __main__()
'''
######solucion para los acentos en mayuscula de la funcion upper()
