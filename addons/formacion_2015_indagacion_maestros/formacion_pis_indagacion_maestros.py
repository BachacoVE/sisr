...
class for_pis_maestros(osv.osv):
    ...
    _columns = {
        ...
        'apellidos': fields.char('1º y 2º Apellidos', size=120, required=False, help='Apellidos del Formador'),
        'nacionalidad': fields.many2one('for.pis.nacionalidades', 'Nacionalidad', help='Nacionalidad'),
        'fecha_nacimiento': fields.date('Fecha de Nacimiento', required=False, help='Fecha de Nacimiento del Formador'),
        'edad': fields.integer('Edad (años)', required=False, help='Edad del Formador'),
        'genero_id': fields.many2one('for.pis.generos', 'Género', required=False, help='Género (Masculino/Femenino)'),
        ...
        'estado_civil_id': fields.many2one('for.pis.estados_civiles', 'Estado Civil', required=False, help='Estado Civíl del Formador'),
        'hijos_ids': fields.one2many('for.pis.mae_familiares', 'maestro_id', 'Familiares', help='Familiares del Formador'),
        'estado_id': fields.many2one('for.pis.estados', 'Estado', required=False, help='Estado donde reside'),
        'municipio_id': fields.many2one('for.pis.municipios', 'Municipio', required=False, help='Municipio donde reside'),
        'parroquia_id': fields.many2one('for.pis.parroquias', 'Parroquia', required=False, help='Parroquia donde reside'),
        'comunidad_id': fields.many2one('for.pis.tipos_comunidades','Comunidad', required=False, help='Tipo de comunidad donde reside'),
        'direccion_habitacion': fields.char('Dirección Habitación', size=120, required=False, help='Dirección de habitación donde reside'),
        ...
        'cuenta_id': fields.char('Cuenta Formador', size=20, required=False, help='Número de la Cuenta Bancaria donde el Formador desea que sea realiado su pago'),
...
class for_pis_maestros_registro_inicial_extended(osv.osv):
    ...
    _columns = {
        'pis_maestro_formacion_ids': fields.one2many('for.pis.mae_participacion_pis', 'numero_id', 'Formadores en esta Formacion', help='Formadores que participan en la Formación'),
    }
...
class for_pis_mae_participacion_pis(osv.osv):
    ...
    def create(self, cr,uid, vals, context=None):
        ...
        return super(for_pis_mae_participacion_pis, self).create(cr,uid, vals, context)
