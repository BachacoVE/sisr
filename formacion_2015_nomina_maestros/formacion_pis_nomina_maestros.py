...
class for_pis_mae_misiona01(osv.osv):
    ...
    _columns = {
        ...
        'fec_nac': fields.date('fec_nac',required=True, help='fec_nac : date'),
        'sexo': fields.char('sexo',size=1,required=True, help='sexo : char(1)'),
        'fec_ing': fields.date('fec_ing',required=True, help='fec_ing : date'),
        'fec_egr': fields.date('fec_egr',required=True, help='fec_egr : date'),
        ...
        'fec_sta': fields.date('fec_sta',required=True, help='fec_sta : date'),
...
class for_pis_mae_misiona05(osv.osv):
    ...
    _columns = {
        ...
        'fec_ini': fields.date('fec_ini',required=True, help='fec_ini'),
        'fec_fin': fields.date('fec_fin',required=True, help='fec_fin'),
        ...
        'fec_usu': fields.date('fec_usu', required=True, help='fec_usu : date'),
        'hor_usu': fields.char('hor_usu', size=10, required=True, help='hor_usu : char(10)'),
    }
