...
class for_pis_sujetos_aprendizaje(osv.osv):
    ...
    _columns = {
        ...
        'fecha_nacimiento': fields.datetime('Fecha de Nacimiento', required=True, help='Fecha de Nacimiento del Participante'),
...
class for_pis_familiares(osv.osv):
    """Registro Maestro de Familiares de los Participantes y/o Facilitadores"""
    ...
    _columns = {
        ...
        'parentesco_id': fields.many2one('for.pis.parentescos', 'Parentesco', help='Parentesco con el Participante o Facilitador'),
...
class for_pis_redes_sociales(osv.osv):
    """Registro Maestro de Redes Sociales a las que estan suscritos los Participantes y los Facilitadors"""
    ...
    _columns = {
        ...
        'tipo_red_social_id': fields.many2one('for.pis.tipos_redes_sociales', 'Tipo de Red Social', help='Nombre de la Red Social a la que esta suscrito el Sujeto de Aprendizaje o el Facilitador'),
...
class for_pis_organizaciones_milita(osv.osv):
    """Registro Maestro de Organizaciones Socio-Políticas donde militan los Participantes y Facilitadores"""
    ...
    _columns = {
        ...
        'organizacion_id': fields.many2one('for.pis.organizaciones', 'Organización Social o Política', help='Organización Social o Política donde milita el Participante o Facilitador'),
        'desde': fields.datetime('Desde', required=False, help='Fecha desde la cual el Participante o Facilitador participa o milita en la referida Organización Social o Política'),
    }
for_pis_organizaciones_milita()

class for_pis_misiones_pertenece(osv.osv):
    """Registro Maestro de Misiones Sociales a las que pertenecen los Participantes y Facilitador"""
...
class for_pis_tecnologias_utilizadas(osv.osv):
    """Registro Maestro de Tecnologías de Información y Comunicación utilizadas por Facilitadores y Participantes"""
...
class for_pis_discapacidades(osv.osv):
    """Registro Maestro de Discapacidades de los Participantes y Facilitadores"""
