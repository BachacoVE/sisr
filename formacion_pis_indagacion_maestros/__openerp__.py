...
{
        "name" : "formacion_pis_indagacion_maestros",
        "version" : "0.3",
        ...
        "depends" : ['base','formacion_pis_base','formacion_pis_indagacion', 'formacion_pis_nomina_maestros'],
        "init_xml" : [ ],
        "demo_xml" : [ ],
        "update_xml" : ['data/for.pis.mae_tipos_cuenta.csv', 'formacion_pis_indagacion_maestros_view.xml'],
        "installable": True
}
