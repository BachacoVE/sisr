...
# Generated by the OpenERP plugin for Dia !
{
        ...
        "depends" : ['base'],
        "init_xml" : ['data/sectores_economicos.xml', 'data/areas_economicas.xml', 'data/subareas_economicas.xml', 'data/for.pis.tipos_procedencias.csv', 'data/estados.xml', 'data/municipios.xml', 'data/parroquias.xml', 'data/cfs.xml'],
        "demo_xml" : [ ],
