...
# Generated by the OpenERP plugin for Dia !
{
        ...
        "update_xml" : ['security/for_pis_base.xml', 'security/ir.model.access.csv','security/ir.rule.xml', 'formacion_pis_base_view.xml', 'data/for.pis.opciones_formativas.csv', 'data/areas_priorizadas.xml','data/for_dependencia_REG.xml', 'sequence_preimpreso.xml','data/for.pis.calendario.csv','report/reports.xml'],
        "installable": True
}
