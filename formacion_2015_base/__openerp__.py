...
# Generated by the OpenERP plugin for Dia !
{
        ...
        "update_xml" : ['security/for_pis_base.xml', 'security/ir.model.access.csv', 'formacion_pis_base_view.xml', 'data/for.pis.opciones_formativas.csv', 'data/areas_priorizadas.xml'],
        "installable": True
}
