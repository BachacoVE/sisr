...
class for_pis_opciones_formativas(osv.osv):
    ...
    _columns = {
        ...
        'motores_economicos_id': fields.many2one('for.pis.motores_economicos', 'Motores Economicos', required=False, help='Seleccione cual de los Motores Productivos corresponde la modalidad de Formación: Agroindustria, Hidrocarburo-Petroquímica, Hierro-Acero, Sector Eléctrico, Telecomunicaciones, Turismo, Construcción, Ciencia e Innovación y Diseño, Manufactura-Autopartes, Mineria, Textil-Calzado y Servicios'),
        'identificador': fields.char('Codigo',size=12, help='Código Único Identificador de la Formación de 11 caracteres. Ej: PISMIR00030'),
        'denominacion': fields.char('Denominacion',size=240,required=True, help='Denominación del Curso'),
