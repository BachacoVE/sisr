-- View: report_consolidado_regiones

-- DROP VIEW report_consolidado_regiones;

CREATE OR REPLACE VIEW report_consolidado_regiones AS 
...
ALTER TABLE report_consolidado_regiones
  OWNER TO openerp;
