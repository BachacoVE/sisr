...
# Generated by the OpenERP plugin for Dia !
{
        ...
        "update_xml" : ['security/formacion_pis_mae_liquidaciones.xml','security/ir.model.access.csv', 'formacion_pis_mae_liquidaciones_view.xml', 'report/reports.xml', 'data/for.pis.mae_modalidades_liquidacion.csv','data/for.pis.mae_motivos_egreso.csv', 'data/for.pis.mae_tasas_bcv_prestaciones.csv', 'data/for.pis.mae_tipos_asignaciones.csv', 'data/for.pis.mae_tipos_deducciones.csv', 'data/sisr.pla.dependencias_administrativas.csv'],
        "installable": True
}
